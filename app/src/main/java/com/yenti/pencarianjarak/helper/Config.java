package com.yenti.pencarianjarak.helper;

/**
 * Created by Yenti on 4/17/2018.
 *
 */
...
public class Config {
    ...
    public static final String URL_Bulan = Base_URL +"/getBulan.php";
    public static final String URL_Event = Base_URL +"/getEvent.php";

    //JSON Tags
    public static final String Key_nama = "nama_wisata";
